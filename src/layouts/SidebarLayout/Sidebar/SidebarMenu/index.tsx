            ...
            >
              <ListItem component="div">
                <NextLink href="/user" passHref>
                  <Button
                    className={currentRoute === '/user' ? 'active' : ''}
                    disableRipple
                    component="a"
                    onClick={closeSidebar}
                    startIcon={<PersonSearchTwoTone />}
                  >
                    유저 정보 조회
                  </Button>
                </NextLink>
              ...
              <ListItem component="div">
                <NextLink href="/guild" passHref>
                  <Button
                    className={currentRoute === '/guild' ? 'active' : ''}
                    disableRipple
                    component="a"
                    onClick={closeSidebar}
                    startIcon={<GroupsTwoTone />}
                  >
                    클럽 정보 조회
                  </Button>
                </NextLink>
              ...
              <ListItem component="div">
                <NextLink href="/pay" passHref>
                  <Button
                    className={currentRoute === '/pay' ? 'active' : ''}
                    disableRipple
                    component="a"
                    onClick={closeSidebar}
              ...
              <ListItem component="div">
                <NextLink href="/removeuser" passHref>
                  <Button
                    className={currentRoute === '/removeuser' ? 'active' : ''}
                    disableRipple
                    component="a"
                    onClick={closeSidebar}
                    startIcon={<PersonRemoveTwoTone />}
                  >
                    탈퇴 내역 조회
                  </Button>
                </NextLink>
              ...
              <ListItem component="div">
                <NextLink href="/abusing" passHref>
                  <Button
                    className={currentRoute === '/abusing' ? 'active' : ''}
                    disableRipple
                    component="a"
                    onClick={closeSidebar}
                    startIcon={<DoNotTouchTwoTone />}
                  >
                    어뷰징 조회
                  </Button>
                </NextLink>
              ...
              <ListItem component="div">
                <NextLink href="/notice" passHref>
                  <Button
                    className={currentRoute === '/notice' ? 'active' : ''}
                    disableRipple
                    component="a"
                    onClick={closeSidebar}
