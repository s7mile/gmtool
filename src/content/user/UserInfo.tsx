import { Apple, Google, Remove } from '@mui/icons-material';
import {
  TableContainer,
  Table,
  TableHead,
            ...
            <ListItemText
              ...
              secondary={
                <Tooltip
                  ...
                  followCursor
                >
                  {getOnOffLabel(feed[0].public_profile)}
                </Tooltip>
              }
            />
            <Box textAlign={'right'}>
      ...
      <TableContainer component={Paper}>
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          <TableBody>
            ...
            <TableRow>
              <TableCell align="center">{feed[0].db_shard_id}</TableCell>
              <TableCell align="center">{feed[0].version}</TableCell>
              <TableCell align="center">{getMarket(feed[0].market)}</TableCell>
              <TableCell align="center">
                {feed[0].friends_count} ({' '}
                {feed[0].friends_count - feed[0].game_friends_count} /{' '}
                {feed[0].game_friends_count})
              </TableCell>
            </TableRow>
            <TableRow>
              <TableCell align="center" variant="head" component="th">
            ...
            <TableRow>
              ...
              <TableCell align="center">{feed[0].deco_ranking.score}</TableCell>
              <TableCell align="center">
                <Typography>{feed[0].today_visit_count}</Typography>
                <Button variant="contained" size="small" color="inherit">
                  방문 기록
                </Button>
              </TableCell>
              <TableCell align="center">
                <Typography>{feed[0].total_visit_count}</Typography>
                <Button variant="contained" size="small" color="inherit">
                  보상 기록
                </Button>
                <Button variant="contained" size="small" color="inherit">
